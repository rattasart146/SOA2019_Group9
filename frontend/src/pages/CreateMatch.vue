        ...
        <div class="col creat-match-form">
          ...
          <div class="row form-creat-match">
            <div class="col-12 top-text">
             ...
             <form @submit="doRegis">
            <div class="col-12">
              <input v-model="register.inputUsername" placeholder="ชื่อการแข่งขัน" type="text" id="match-name">
            </div>
            <div class="col-12">
              <input v-model="register.inputPassword" placeholder="ชื่อผู้จัดการแข่งขัน ex. หน่วยงาน องค์กร" type="text" id="match-owner">
            </div>
            <div class="col-12">
              <input v-model="register.inputFirstname" placeholder="สถานที่จัดการแข่งขัน" type="text" id="match-address">
            </div>
            <div class="col-12">
              <input v-model="register.inputLastname" placeholder="รายละเอียดการแข่งขัน" type="text" id="match-detail">
            </div>
            <div class="col-12">
              <input v-model="register.inputLastname" placeholder="วันเปิด-ปิดรับสมัคร" type="text" id="match-date">
            </div>
            <div class="row">
                <div class="col-3"></div>
                <div class="col-3">
